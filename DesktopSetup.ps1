<#
    .Synopsis
        Checks for missing shortcuts and creates any that are missing. Also checks the user has the correct printer installed
    .Examples
#>

$deskTopPath = [Environment]::GetfolderPath("Desktop")
$allDesktopPath = [Environment]::Getfolderpath("CommonDesktopdirectory")
$currentShortcuts = ,@(get-childitem -path $deskTopPath, $allDesktopPath | Select-Object basename )
...
$checkPrinter = get-printer | Where-Object {$_.shareName -eq 'FollowMe_Plaza'}
If (-not $checkPrinter) { 
